                ...
                <div className="row">
                    <div className="col recuardo1eracolumna">
                        <div className={"Textorecuadro"}>
                            ...
                            <Button class="btn btn-info" variant={"outline-dark"} href={"/Reservas"}>Buscar kanguro</Button>
                        </div>
                    </div>
                    ...
                    <div className="col recuardo2ndacolumna">
                        <div className={"Textorecuadro"}>
                            ...
                            <Button class="btn btn-warning" variant={"outline-dark"} href={"/ComoSerKanguro"}>Trabaja con nosotros</Button>
                        </div>
                    </div>
                </div>
            </div>
